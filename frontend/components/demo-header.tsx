...
export function DemoHeader({ rightButton = null }: DemoHeaderProps) {
          ...
          <div className='relative' data-dropdown='user'>
            ...
            {showUserMenu && (
              <div className='absolute right-0 top-12 w-64 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border border-slate-200/50 dark:border-slate-700/30 rounded-2xl shadow-2xl z-50 p-4 overflow-hidden'>
                ...
                <button className='w-full flex items-center space-x-3 px-3 py-2 text-left hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg transition-colors text-red-500 hover:text-red-600'>
